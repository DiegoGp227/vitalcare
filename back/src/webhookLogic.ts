...
// // =======================================================
// /**
//  * ESTADO DE LA CONVERSACIÓN: Ahora almacena la cédula (ID) del paciente.
//  */

// export const userSessionState: { 
//     [key: string]: {
//         state: 'START' | 'ASKING_CEDULA' | 'ASKING_SYMPTOMS' | 'DONE' | 'REJECTED',
//         pacienteId?: string // ✅ Campo para guardar el ID
//     }
// } = {};
...
//             const user = pacientes[0];
//             const fullName = `${user.nombre} ${user.apellido}`.trim();
//             // Asumiendo que la cédula es el pacienteid en la tabla síntomas
//             return { isValid: true, name: fullName, id: user.id }; 
//         } else {
//             return { isValid: false, name: null, id: null };
//         }
...
//     if (isValid) {
//         // Cédula VÁLIDA: Guarda la cédula y pide síntomas
//         userSessionState[from] = {
//             state: 'ASKING_SYMPTOMS',
//             cedula: cedula // 🎯 GUARDAMOS LA CÉDULA AQUÍ
//         };
...
//     // Convertimos pacienteid a número si la columna lo requiere (asumiendo que es int)
//     const pacienteIdNum = parseInt(pacienteid, 10);
//     if (isNaN(pacienteIdNum)) {
//         console.error("❌ pacienteid no es un número válido.");
//         return;
//     }
...
//             insert_sintomas_one(object: {
//                 demo: true,
//                 dolor: "${dolor.replace(/"/g, '\\"')}",
//                 fecha: "${fechaActual}",
//                 pacienteid: ${pacienteIdNum},
//                 zonadolor: "${zonadolor.replace(/"/g, '\\"')}"
//             }) {
//                 id
//             }
//         }
...
//             // 1. Obtener la CÉDULA/ID del paciente guardada previamente
//             const pacienteid = userSession.cedula;
